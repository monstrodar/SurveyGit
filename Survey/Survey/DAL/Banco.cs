...
namespace Survey.DAL
{
    ...
    internal class Banco
    {
        ...
        protected Banco()
        {
            _strConexao = @"Data Source=den1.mssql4.gear.host;Initial Catalog=banco;Persist Security Info=True;User ID=banco;Password=Hv9X8?45IYU-";
        ...
        protected int ExecutaComando(bool transacao = false)//ok-alt-conf//ok-exc-conf///novo-conf///novo quest
        {
